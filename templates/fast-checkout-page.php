...
<div class="fcui__name">
<?php echo esc_html($title); ?>
</div>

<div class="fcui__sumRow">

<div class="fcui__sumPrice">
<?php echo wp_kses_post(wc_price($price)); ?>
</div>

<?php if ($has_discount): ?>
<div class="fcui__sumDiscount">
<span class="fcui__sumRegular">
<?php echo wp_kses_post(wc_price($regular)); ?>
</span>

<span class="fcui__badge">
<?php echo esc_html($discount_pct); ?>% تخفیف
</span>
</div>
<?php endif; ?>
...
<div class="fcui__hint">
بعد از پرداخت موفق، دسترسی شما همان لحظه فعال می‌شود.
</div>
...
<div class="fcui__alert">
لطفاً اطلاعات را کامل کنید و روش پرداخت را انتخاب کنید.
</div>
<?php endif; ?>
...
<input name="billing_full_name"
value="<?php echo esc_attr($prefill['full_name']); ?>"
...
<?php checked($id,$first_gateway); ?>>

<span class="fcui__gwBox">

<span class="fcui__gwIcon">
<?php echo wp_kses_post($gateway->get_icon()); ?>
</span>

<span class="fcui__gwTitle">
...
<button type="submit"
name="fcui_free_register"
value="1"
class="fcui__btn fcui__btn--primary">
ثبت نام رایگان
</button>
...
value="1"
class="fcui__btn fcui__btn--primary">
پرداخت و ثبت‌نام آنی
</button>

<?php endif; ?>

<button type="submit"
name="fcui_add_to_cart_later"
value="1"
class="fcui__btn fcui__btn--ghost">

<span class="fcui__btnLine">
بعداً پرداخت می‌کنم
</span>

<span class="fcui__btnSub">
افزودن به سبد خرید
</span>
